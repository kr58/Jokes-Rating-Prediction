...
https://github.com/cheungdaven/DeepRec/blob/master/models/rating_prediction/mf.py
"""
...
class MF():
    ...
    def test(self, test_data):
        ...
        print("RMSE:" + str(RMSE(error, len(test_set))[0]) + "; MAE:" + str(NMAE(error_mae, len(test_set))[0]))
